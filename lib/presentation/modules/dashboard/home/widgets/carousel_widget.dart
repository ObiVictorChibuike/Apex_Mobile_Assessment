    ...
    return Padding(
      ...
      child: Container(width: MediaQuery.of(context).size.width, height: MediaQuery.of(context).size.height / 8,
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Container(
                height: 60, width: 60, decoration: BoxDecoration(color: const Color(0xffDCF6E6), borderRadius: BorderRadius.circular(4)),
              ...
              Expanded(
                child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(widget.title!, style: Theme.of(context).textTheme.bodyText2?.copyWith(color: const Color(0xFF258DEE), fontSize: 16, fontWeight: FontWeight.w700),),
                    const SizedBox(height: 10,),
                    Text(widget.message!, style: Theme.of(context).textTheme.bodyText2?.copyWith(color: const Color(0xff3A3A3A), fontSize: 14, overflow: TextOverflow.ellipsis),),
                  ],
                ),
              ),
